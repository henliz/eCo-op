...
const DashboardPage: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full justify-start gap-3 h-12 hover:bg-green-50 transition-colors" onClick={() => window.location.href = '/plan'}>
  ...
  const renderPreferences = () => (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8 text-center">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-4" style={headingFont}>Preferences</h2>
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-100">
        <p className="text-gray-600 text-lg">Preferences to be inserted</p>
        <p className="text-sm text-gray-500 mt-2">Dietary restrictions, favorite cuisines, cooking skill level, and more coming soon!</p>
      </div>
    </div>
  );
